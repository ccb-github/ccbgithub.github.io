...
var QRUtil = {
    ...
    getMask (maskPattern: string, i: number, j: number) {
    ...
    getLengthInBits (mode: string, type: string | number) {
	    if (1 <= type && type < 10) {
		    // 1 - 9
		    switch(mode) {
...
class QRPolynomial {
  ...
  constructor(num: string | any[], shift: string | number){
